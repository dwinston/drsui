(() => {
  ...
  // elm:/Users/dwinston/Dropbox/repos/polyneme/drsui/src/Main.elm
  var require_Main = __commonJS({
    "elm:/Users/dwinston/Dropbox/repos/polyneme/drsui/src/Main.elm"(exports) {
      (function(scope) {
        "use strict";
        ...
        var $author$project$Route$parser = $elm$url$Url$Parser$oneOf(_List_fromArray([
          A2($elm$url$Url$Parser$map, $author$project$Route$Login, A2($elm$url$Url$Parser$slash, $elm$url$Url$Parser$top, $elm$url$Url$Parser$s("login")))
        ]));
        var $author$project$Route$parse = function(url) {
          return A2($elm$core$Maybe$withDefault, $author$project$Route$NotFound, A2($elm$url$Url$Parser$parse, $author$project$Route$parser, url));
        };
        var $author$project$Main$init = F3(function(_v0, url, key) {
          return _Utils_Tuple2({
            draftClientId: "",
            draftClientSecret: "",
            jwt: $elm$core$Maybe$Nothing,
            key,
        ...
        var $author$project$Main$GotLoginResponse = function(a) {
          return { $: "GotLoginResponse", a };
        };
        var $author$project$Jwt$Jwt = function(a) {
          return { $: "Jwt", a };
        };
        var $author$project$Jwt$fromString = $author$project$Jwt$Jwt;
        var $author$project$Jwt$decoder = A2($elm$json$Json$Decode$field, "access_token", A2($elm$json$Json$Decode$map, $author$project$Jwt$fromString, $elm$json$Json$Decode$string));
            ...
            while (true) {
              if (!cmds.b) {
                ...
                if (cmd.$ === "Cancel") {
                  ...
                  var req = cmd.a;
                  return A2($elm$core$Task$andThen, function(pid2) {
                    var _v4 = req.tracker;
                    if (_v4.$ === "Nothing") {
                      return A3($elm$http$Http$updateReqs, router, otherCmds, reqs);
                    } else {
                      var tracker2 = _v4.a;
                      return A3($elm$http$Http$updateReqs, router, otherCmds, A3($elm$core$Dict$insert, tracker2, pid2, reqs));
                    }
        ...
        var $elm$http$Http$post = function(r) {
          return $elm$http$Http$request({ body: r.body, expect: r.expect, headers: _List_Nil, method: "POST", timeout: $elm$core$Maybe$Nothing, tracker: $elm$core$Maybe$Nothing, url: r.url });
        };
          ...
          switch (msg.$) {
            case "UrlRequest":
              if (msg.a.$ === "Internal") {
                ...
                var str = msg.a.a;
                return _Utils_Tuple2(model, $elm$browser$Browser$Navigation$load(str));
              }
            case "UrlChange":
              var url = msg.a;
              return _Utils_Tuple2(_Utils_update(model, {
            ...
            case "UserWantsToLogin":
              return _Utils_Tuple2(model, $elm$http$Http$post({
                body: A2($elm$http$Http$stringBody, "application/x-www-form-urlencoded", A2($elm$core$String$dropLeft, 1, $elm$url$Url$Builder$toQuery(_List_fromArray([
                  A2($elm$url$Url$Builder$string, "grant_type", "client_credentials"),
                  A2($elm$url$Url$Builder$string, "client_id", model.draftClientId),
                  A2($elm$url$Url$Builder$string, "client_secret", model.draftClientSecret)
                ])))),
                expect: A2($elm$http$Http$expectJson, $author$project$Main$GotLoginResponse, $author$project$Jwt$decoder),
                url: "/api/token"
              }));
            case "UserTypedInClientIdField":
              var newDraftClientId = msg.a;
              return _Utils_Tuple2(_Utils_update(model, { draftClientId: newDraftClientId }), $elm$core$Platform$Cmd$none);
            case "UserTypedInClientSecretField":
              var newDraftClientSecret = msg.a;
              return _Utils_Tuple2(_Utils_update(model, { draftClientSecret: newDraftClientSecret }), $elm$core$Platform$Cmd$none);
            default:
              if (msg.a.$ === "Err") {
                var e = msg.a.a;
                return _Utils_Tuple2(model, _Debug_todo("Main", {
        ...
        var $author$project$Main$UserTypedInClientIdField = function(a) {
          return { $: "UserTypedInClientIdField", a };
        };
        var $author$project$Main$UserTypedInClientSecretField = function(a) {
          return { $: "UserTypedInClientSecretField", a };
        };
        var $author$project$Main$UserWantsToLogin = { $: "UserWantsToLogin" };
        ...
        var $author$project$Main$viewPageContent = function(model) {
          var _v0 = model.route;
          if (_v0.$ === "Login") {
            return A2($elm$html$Html$form, _List_fromArray([
              $elm$html$Html$Events$onSubmit($author$project$Main$UserWantsToLogin)
            ]), _List_fromArray([
              A2($elm$html$Html$label, _List_Nil, _List_fromArray([
                $elm$html$Html$text("client ID"),
                A2($elm$html$Html$input, _List_fromArray([
                  $elm$html$Html$Attributes$type_("text"),
                  $elm$html$Html$Attributes$value(model.draftClientId),
                  $elm$html$Html$Events$onInput($author$project$Main$UserTypedInClientIdField)
                ]), _List_Nil)
              ])),
              A2($elm$html$Html$label, _List_Nil, _List_fromArray([
                $elm$html$Html$text("client secret"),
                A2($elm$html$Html$input, _List_fromArray([
                  $elm$html$Html$Attributes$type_("password"),
                  $elm$html$Html$Attributes$value(model.draftClientSecret),
                  $elm$html$Html$Events$onInput($author$project$Main$UserTypedInClientSecretField)
                ]), _List_Nil)
              ])),
            ...
            return $elm$html$Html$text("NotFound");
          }
        };
        var $author$project$Main$view = function(model) {
          return {
            body: _List_fromArray([
              A2($elm$html$Html$header, _List_Nil, _List_fromArray([
                ...
                function() {
                  var _v0 = model.jwt;
                  if (_v0.$ === "Nothing") {
                    return A2($elm$html$Html$nav, _List_Nil, _List_fromArray([
                      A2($elm$html$Html$a, _List_fromArray([
              ...
              A2($elm$html$Html$main_, _List_Nil, _List_fromArray([
                $author$project$Main$viewPageContent(model)
              ])),
              A2($elm$html$Html$footer, _List_Nil, _List_fromArray([
        ...
        _Platform_export({ "Main": { "init": $author$project$Main$main($elm$json$Json$Decode$succeed(_Utils_Tuple0))({ "versions": { "elm": "0.19.1" }, "types": { "message": "Main.Msg", "aliases": { "Url.Url": { "args": [], "type": "{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }" } }, "unions": { "Main.Msg": { "args": [], "tags": { "UrlRequest": ["Browser.UrlRequest"], "UrlChange": ["Url.Url"], "UserWantsToLogin": [], "UserTypedInClientIdField": ["String.String"], "UserTypedInClientSecretField": ["String.String"], "GotLoginResponse": ["Result.Result Http.Error Jwt.Jwt"] } }, "Http.Error": { "args": [], "tags": { "BadUrl": ["String.String"], "Timeout": [], "NetworkError": [], "BadStatus": ["Basics.Int"], "BadBody": ["String.String"] } }, "Basics.Int": { "args": [], "tags": { "Int": [] } }, "Jwt.Jwt": { "args": [], "tags": { "Jwt": ["String.String"] } }, "Maybe.Maybe": { "args": ["a"], "tags": { "Just": ["a"], "Nothing": [] } }, "Url.Protocol": { "args": [], "tags": { "Http": [], "Https": [] } }, "Result.Result": { "args": ["error", "value"], "tags": { "Ok": ["value"], "Err": ["error"] } }, "String.String": { "args": [], "tags": { "String": [] } }, "Browser.UrlRequest": { "args": [], "tags": { "Internal": ["Url.Url"], "External": ["String.String"] } } } } }) } });
      })(exports);
    }
  });
